...
$config['DX_website_name'] = 'Sistema Contable Basico';
$config['DX_webmaster_email'] = 'sys@contable.com.ar';
...
$config['DX_captcha_width'] = 170;
$config['DX_captcha_height'] = 50;
$config['DX_captcha_font_size'] = '18'; 
...
// Forms view
$config['DX_login_view'] = 'auth_login_form';
$config['DX_register_view'] = 'auth_register_form';
$config['DX_forgot_password_view'] = 'auth_forgot_password_form';
$config['DX_change_password_view'] = 'auth_change_password_form';
$config['DX_cancel_account_view'] = 'auth_cancel_account_form';

// Pages view
$config['DX_deny_view'] = 'auth_general_message';
$config['DX_banned_view'] = 'auth_general_message';
$config['DX_logged_in_view'] = 'auth_general_message';
$config['DX_logout_view'] = 'auth_general_message';

$config['DX_register_success_view'] = 'auth_general_message';
$config['DX_activate_success_view'] = 'auth_general_message';
$config['DX_forgot_password_success_view'] = 'auth_general_message';
$config['DX_reset_password_success_view'] = 'auth_general_message';
$config['DX_change_password_success_view'] = 'auth_general_message';

$config['DX_register_disabled_view'] = 'auth_general_message';
$config['DX_activate_failed_view'] = 'auth_general_message';
$config['DX_reset_password_failed_view'] = 'auth_general_message';
